export const componentStyles = {
    ...
    modal: {
        backdropClass: 'absolute w-screen h-screen z-[5] cursor-pointer ',
        containerClass: 'w-max min-w-40 overflow-x-hidden min-h-30 z-[12] absolute bg-sidebarBackground dark:bg-sidebarBackgroundDark rounded-md p-2'
    },
    notificationModal: {
        containerClass: 'p-1 mb-2 border-b-2 border-gray-600 dark:border-gray-100 rounded-md cursor-pointer hover:bg-black hover:bg-opacity-20 hover:dark:bg-white hover:dark:bg-opacity-20',
        iconClass: 'absolute top-0 inline-flex items-center justify-center px-1.5 py-1 text-xs font-bold leading-none text-red-100 bg-red-600 rounded-full -right-1 -top-2'
    },
    textInput: {
